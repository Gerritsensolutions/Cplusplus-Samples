...
class queue  
{
  ...
  class Overflow{};  // Overflow class thrown as an exception during queue Overflow
  class Underflow{}; // Underflow class thrown as an exception during queue Underflow
